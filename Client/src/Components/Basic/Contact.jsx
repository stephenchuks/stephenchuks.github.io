    ...
    return (
        ...
        <Container fluid>
            <Row className='className="mt-5 pt-5 mb-5 justify-content-center align-items-center'>
                ...
                <p class="text-center text-primary w-responsive mx-auto mb-5">
                    <i>
                ...
                <Row>
                    ...
                    <div class="col-md-6 mb-md-0 mb-5">
                        <Form id="contact-form">
                            ...
                            <Button variant="primary" style={{backgroundColor: '#5dbcd2'}} className='mt-2 col-md-12'>Send</Button>
                    ...
                    <div class="col-md-6 text-center">
                        <ul class="list-unstyled mb-0">
                            <li>
                                <p><FontAwesomeIcon icon={faHome} /> Mesa Geitonia, Limasol, Cyprus</p>
                            </li>
                            ...
                            <li><i class="mt-4 fa-2x"></i>
                                <p> <FontAwesomeIcon icon={faMessage} /> admin@ajebomart.com</p>
                            </li>
                        </ul>
                    </div>
