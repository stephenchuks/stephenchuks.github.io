...
const HeadNav = () => {
    ...
    return (
        <Navbar variant="light" expand="md" fixed="top" className="navbar-bg nav_mo px-2" style={{backgroundColor: '#5dbcd2'}}>
            <Nav className="container-fluid">
                <Navbar.Brand href="/" className='nav_logo'>AjeboMart</Navbar.Brand>
                ...
                <Navbar.Collapse id="navbar-nav">
                    <Nav className="ml-auto">
                        ...
                        {user ? (
                            ...
                            <Button variant="danger" style={{backgroundColor: '#5dbcd2'}}  onClick={handleLogout} >
